...
class MotorcycleTest extends TestCase
{
     ...
     * @var string
     */
    protected $endpoint = '/api/motorcycle/';
    ...
    {
        parent::setUp();
        $this->model = Motorcycle::factory()->create();
    ...
    public function index_endpoint_works_as_expected()
    {
        $this->getJson($this->endpoint, $this->header)
            ...
            ->assertJsonFragment([
                ...
                'transmission_type' => $this->model->getAttribute('transmission_type'),
                'suspension_type' => $this->model->getAttribute('suspension_type'),
            ]);
    }
    ...
    public function delete_endpoint_works_as_expected()
    {
        ...
        $this->assertDatabaseHas('motorcycles', [
            ...
            "transmission_type" => $this->model->transmission_type,
            "suspension_type" => $this->model->suspension_type,
        ]);
